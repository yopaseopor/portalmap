export const es = {
    ...
    barcelonaBikeStationsTitle: 'Estaciones de Bicicletas de Barcelona - Tiempo Real',
    showBarcelonaBikeStations: '🚲 Mostrar Estaciones de Bicicletas de Barcelona',
    hideBarcelonaBikeStations: '🚲 Ocultar Estaciones de Bicicletas de Barcelona',
    ...
    availableDocks: 'Aparcaderos Disponibles',
    activeStations: 'Estaciones Activas',
    stations: 'estaciones',
    bikesAvailable: 'bicicletas disponibles',
    docksAvailable: 'aparcaderos disponibles',
    searchStationsByName: 'Buscar estaciones por nombre...',
    station: 'Estación',
    bikes: 'Bicicletas',
    types: 'Tipos',
    docks: 'Aparcaderos',
    ...
    of: 'de',
    refresh: 'Actualizar',
    bikeTypesAvailable: '🚲 Tipos de Bicicletas Disponibles:',
    availableBikesLabel: '🚲 Bicicletas disponibles:',
    availableDocksLabel: '📍 Aparcaderos disponibles:',
    capacity: '📊 Capacidad:',
    statusLabel: '📡 Estado:',
    updated: '🕒 Actualizado:',
    availableByType: '🚲 Disponible por Tipo:',
    unknownStation: 'Estación Desconocida',
    unknown: 'Desconocido',
    // Bike station status messages
    notRenting: 'No alquila',
    notReturning: 'No devuelve',
    notInstalled: 'No instalada',
    active: 'Activa',
    // Vehicle types
    regularBike: 'Bicicleta Normal',
    electricBike: 'Bicicleta Eléctrica',
    electricScooter: 'Patinete Eléctrico',
    manualScooter: 'Patinete Manual',
    eBikeAssist: 'Asistencia E-Bike',
    cargoBike: 'Bicicleta de Carga',
    gasVehicle: 'Vehículo de Gas',
    bike: 'Bici',
    eBike: 'E-Bici',
    eScoot: 'E-Patinete',
    scooter: 'Patinete',
